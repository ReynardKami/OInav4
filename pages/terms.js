...
const SubText = styled.h3`
  ...
  padding: 1rem;
  font-weight: 300;
  /* text-shadow: 1px 1px 1px #543211; */
  ...
  return (
    <Section>
      <Container>
        ...
        <SubText>
          Ō-Inari NFTs Defined: <br />
          “Ō-Inari NFT(s)” refers to a collection of digital artworks running on
          the Ethereum blockchain. Ō-Inari License Agreement: These terms and
          conditions (“Terms”) define the relationship between (“Ō-Inari”), and
          any person (“You”, “User”) interacting with: (i) Websites owned and
          operated by Ō-Inari; (ii) Social media accounts or pages operated by
          Ō-Inari; (iii) Ō-Inari operated smart contracts on the Ethereum
          network; or (iv) Any and all Ō-Inari operated services. Additionally,
          these terms and conditions define the relationship between Ō-Inari and
          any person who maintains ownership of any Ō-Inari NFTs (“owners”).{" "}
        </SubText>

        <SubText>
          Responsibility of Ownership: <br />
          Owners recognize that they are solely responsible for the security of
          their Ō-Inari NFTs, as well as the safety, protection, and management
          of their Ethereum wallets, which includes any associated passwords,
          seed phrases, seed words, or private keys. Ō-Inari, shall not, in any
          event whatsoever, be held responsible for any risk associated with
          yours or another’s access and/or use of your Ethereum wallet whether
          through the interaction of a Ō-Inari operated service or otherwise. In
          the unfortunate event that your Ō-Inari NFT is lost, stolen,
          transferred, or otherwise remains inaccessible, Ō-Inari cannot
          retrieve it for you.{" "}
        </SubText>
        ...
        <SubText>
          A) By purchasing or lawfully receiving a Ō-Inari NFT, whether through
          a Ō-Inari operated website, or third-party website, and maintaining
          verifiable ownership of the Ethereum wallet in which the Ō-Inari NFT
          is associated you own the Ō-Inari NFT, as well as the Art, subject to
          the definitions and exceptions below. B) Personal Use: Subject to
          owners continued compliance with these Terms and the below defined
          Ownership Exceptions, Ō-Inari grants owners a worldwide, royalty-free
          license to use, copy, and display the Ō-Inari NFT owned, along with
          any extensions they choose to create or use, solely for the following
          purposes: (i) for your own personal, non-commercial use; (ii) as part
          of a marketplace that permits the purchase and sale of your Ō-Inari
          NFT, provided that the marketplace cryptographically verifies each
          Ō-Inari NFT owner’s rights to display the Art for their Ō-Inari NFT to
          ...
          inclusion, involvement, or participation of your Ō-Inari NFT, provided
          that the website/application cryptographically verifies each Ō-Inari
          NFT owner’s rights to display the Art for their Ō-Inari NFT to ensure
          that only the actual owner can display the art, and provided that the
          Art is no longer visible once the owner of the Ō-Inari NFT leaves the
          website/application. C) Commercial Use: Subject to owners continued
          compliance with these Terms and the below defined Ownership
          Exceptions, Ō-Inari grants owners a worldwide license to use, copy,
          and display the purchased Art for the purpose of creating derivative
          works based upon the Art (“Commercial Use”). Examples of such
          ‘Commercial Use’ would be the use of the Art to produce and sell
          merchandise products (T-Shirts etc.) displaying copies of the Art. For
          ...
          the use and sale of Ō-Inari NFT generally, provided that the
          marketplace cryptographically verifies each Ō-Inari NFT owner’s rights
          to display the Art for their Ō-Inari NFT to ensure that only the
          ...
          or participation of Ō-Inari NFT generally, provided that the third
          party website or application cryptographically verifies each Ō-Inari
          NFT owner’s rights to display the Art for their Ō-Inari NFT to ensure
          that only the actual owner can display the Art, and provided that the
          Art is no longer visible once the owner of the Purchased Ō-Inari NFT
          leaves the website/application; or (iii) earning revenue from any of
          the foregoing. D) Ownership Exceptions: Both Personal Use and
          Commercial Use of each Ō-Inari NFT as defined above are subject to the
          following exceptions: (i) owners do not own individual traits as
          defined within the Ō-Inari NFT metadata e.g. “eyes”, “head”, “hands”
          etc. or any individual images, layers, or artworks used in the
          development of Ō-Inari NFTs; these individual traits may not be used
          exclusively, added to existing Ō-Inari NFTs, used to create derivative
          works, or altered i.e. the owner of the Ō-Inari NFT artwork owns the
          Ō-Inari NFT artwork and only the Ō-Inari NFT artwork; (ii) the use of
          artwork developed and distributed by Ō-Inari that are unowned by the
          individual shall not be used, including but not limited to: logos,
          marketing material, trademarks, and/or website material; (iii) owners
          shall not engage in any material, venture, product and/ or service
          which is unlawful, fraudulent, libelous, defamatory, obscene,
          pornographic, profane, threatening, abusive, hateful, offensive,
          objectionable, or unreasonable at the discretion of Ō-Inari; or (iv)
          owners shall not infringe upon any intellectual property rights,
          proprietary rights or confidentiality obligations. Furthermore, owners
          shall indemnify and defend Ō-Inari from and against any and all
          claims, damages, proceedings, loss or costs arising from any such
          prohibited use. Owners shall not use the Ō-Inari NFTs in any way that
          could be construed as being adverse, negative, or derogatory to the
          image and/or reputation of Ō-Inari.
        </SubText>
        ...
        <SubText>
          ...
          own conduct while accessing or RENGA’s Site and for any consequences
          thereof. You agree to use the Site, social medias, and digital assets
          only for purposes that are legal, proper and in accordance with these
          Terms and any applicable laws or regulations. By way of example, and
          not as a limitation, you may not, and may not allow any third party
        ...
        <SubText>
          A. If you elect to purchase a Ō-Inari NFT, any financial transactions
          that you engage in will be conducted solely through the Ethereum
          network. We will have no insight into, or control over these payments
          or transactions. By consequence we do not have the ability to reverse
          any of these transactions. We will have no liability to you, or to any
          other third party, for any claims or damages that may arise as the
          result of any transactions that you engage on, or any other
          transactions that you conduct via the Ethereum network. B. Ethereum
          requires the payment of a transaction fee (a “Gas Fee”) for every
          transaction that occurs on the Ethereum network. The ‘Gas Fee’ funds
        ...
        <SubText>
          ...
          PROVIDED THROUGH THE SITE WILL BE ACCURATE, (IV) THE SITE OR ANY
          CONTENT, SERVICES, OR FEATURES MADE AVAILABLE ON OR THROUGH THE SITE
          ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS, OR (V) THAT ANY DATA
        ...
        <SubText>
          ...
          that you sell your Ō-Inari NFT, please be aware that the prices of
          NFTs are extremely volatile and fluctuations in the prices of other
          NFTs and impact the price of your Ō-Inari NFT both positively and
          negatively. Given the volatility, NFTs such as Ō-Inari should not be
          considered an investment. You assume all risks in that connection. B.
          Ownership of a Ō-Inari NFT confers ownership of digital artwork only.
          Accordingly, no information on this Site (or any other documents
          mentioned therein) is or may be considered advice or an invitation to
          enter into an agreement for any investment purpose. Further, nothing
          on this Site qualifies or is intended to be an offering of securities
          ...
          the artistic nature of the project, Ō-Inari has not been registered
          with or approved by any regulator in any jurisdiction. It remains your
          sole responsibility to assure that the purchase of the Ō-Inari NFT and
          the associated art is compliant with laws and regulations in your
          ...
          unauthorized access to information stored within your wallet. D. NFTs,
          cryptocurrencies and blockchain technology are relatively new and the
          regulatory landscape is unsettled. New regulations could negatively
          impact such technologies impacting the value for your Ō-Inari NFT. You
          understand and accept all risk in that regard. E. You assume all
          responsibility for any adverse effects of disruptions or other issues
        ...
        <SubText>
          You agree to hold harmless and indemnify Ō-Inari and its subsidiaries,
          ...
          judgment, litigation cost, and reasonable attorneys' fees arising out
          of or in any way related to (i) your breach of these Terms, (ii) your
          misuse of the Site, or (iii) your violation of applicable laws, rules
        ...
        <SubText>
          ...
          old to access this Site or purchase a Ō-Inari NFT. If you are under 18
          years old, you are not permitted to use this Site for any reason. By
        ...
        <SubText>
          ...
          arbitrator and will be administered by the American Arbitration
          Association in accordance with its applicable rules. Each party will
          cover its own fees and costs associated with the arbitration
          proceedings. The place of arbitration will be New York, New York. The
          ...
          competent jurisdiction. Notwithstanding the foregoing, we may seek and
